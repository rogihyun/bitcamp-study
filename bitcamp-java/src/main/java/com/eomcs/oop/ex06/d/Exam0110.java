...
public class Exam0110 extends Object{
  ...
  //수퍼 클래스를 지정하지 않으면 기본으로 java.lang.Object클래스가 
  // 수퍼 클래스로 지정된다.
    static class Score {
        String name;
        int kor;
    ...
    public static void main(String[] args) {
        ...
        // 자동으로 java.loan.Object 클래스가 수퍼 클래스로 지정된다.
        // => 그래서 자바의 모든 클래스는 toString이 호출가능하다
        // 즉 자바의 모든 클래스는 Object클래스에 정의된 메서드를 호출할 수 있다.
