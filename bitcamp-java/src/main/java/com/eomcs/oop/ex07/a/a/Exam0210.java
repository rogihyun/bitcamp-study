//캡슐화 문법 사용후 - 개발자가 특정 필드를 직접 접근하지 못하게 막기
package com.eomcs.oop.ex07.a.a;
...
class Score2{
  ...
  //sum 이나 aver 필드는 kor, eng, math 값을 연산한 결과를 보관하기 떄문에
...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    // => 즉 클래스의 멤버만 접근할 수 있고 클래스 외부에서는 접근 할 수 없다.
    // => 그래서 다음과 같이 임의로 접근하여 값을 변경할 수없다.
    //
    //s1.sum =300;   //컴파일오류
    //s1.aver =100f; //컴파일오류
