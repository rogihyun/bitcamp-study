// 스레드 재사용 - 3단계) sleep() / timeout을 활용한 스레드 재사용II
...
public class Exam0130 {
  ...
  public static void main(String[] args) {
    ...
    class MyThread extends Thread{
      ...
      @Override
      public void run() {
        System.out.println("스레드 시작했다");
        try {
          while(true) {
            System.out.println("스레드를 10총동안 잠들게 한다!");
            Thread.sleep(10000);
    ...
    while(true) {
      ...
      // 10초 후에 꺠어났을 때 카운트 값이 설정되어 있지 않으면 다시 잠든다.
