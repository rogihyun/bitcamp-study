...
// 웹브라우저엣 웹서버의 자원을 요청하는 방법
// 1) 서블릿 클래스를 실행하고 싶을 떄
// => 서블릿 클래스의 실제 위치:
// .../톰캣배치폴더/wtpwebapps/bitcamp=java-web/WEB-INT/com/eomcs/web/ex04/Servlet01.class
// => 요청:
// 해당 서블릿을 서버에 등록할 떄 사용한 URL을 지젇해야한다.
// http://localhost:9999/bticamp-java-web/ex04/s1
//
// 2) HTML, CSS, JavaScript JSP 등 정적 파일을 받고 싶을 떄
// => 정적 파일의 실제 위치:
//.../톰캣배치폴더/wtpwebapps/bitcamp=java-web/ex04/test.html
//=> 요청:
//http://localhost:9999/bticamp-java-web/ex04/test.html
//3) /WEB-INF / 폴더에 있는 정저 파일을 받고 싶을 떄
// => 정적 파일의 실제 위치:
//.../톰캣배치폴더/wtpwebapps/bitcamp=java-web/WEB-INT/ex04/test01.html
//=> 요청:
// /WEB-INF 폴더 아래에 있는 파일은 클라이언트에서 요청할 수 없다!
// 웹 애플리케이션의 정보를 두는 폴더이기 떄문이다.
