...
public class App {
  ...
  private static void loadLessonData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 lesson 데이터를 로딩했습니다.\n", count);
  ...
  private static void saveLessonData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 lesson 데이터를 저장했습니다.\n", count);
  ...
  private static void loadMemberData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 member 데이터를 로딩했습니다.\n", count);
  ...
  private static void saveMemberData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 member 데이터를 저장했습니다.\n", count);
  ...
  private static void loadBoardData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 board 데이터를 로딩했습니다.\n", count);
  ...
  private static void saveBoardData() {
    ...
    try {
      ...
      System.out.printf("총 %d 개의 board 데이터를 저장했습니다.\n", count);
